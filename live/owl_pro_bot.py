...
TERMINAL = r"C:\Projects\MT5-KinoliveTrader-Session3\terminal64.exe"
SYMBOL = "BTCUSD"          # PRO demo symbol (7pt spread measured)
TP_USD = 3.0
...
LOG = os.path.join(DIR, "owl_pro.log")
ALIVE = os.path.join(DIR, "owl_pro_alive.json")
STATE = os.path.join(DIR, "owl_pro_state.json")
JOURNAL = os.path.join(DIR, "owl_pro_journal.csv")
MARKETLOG = os.path.join(DIR, "owl_pro_market_log.csv")
        ...
        try:
            ...
            with open(ALIVE, "w") as f:
                json.dump({
                    ...
                    "bot": "OWL-pro-CROC (DEMO 476715495, full size)",

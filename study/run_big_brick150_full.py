"""SPEC_BIG_BRICK_GATE addendum 3 - full battery on the deployed $150 config.
A0 / F150 / rate-matched R (3 seeds), 6 anchors, M1/M5/M15 + H1 check."""
import numpy as np
...
def big_dir_masks(R, brick=BRICK, rev=2):
...
for name, R in (("M1", R1), ("M5", R5), ("M15", R15), ("H1", RH)):
    ...
    print(f"  F150    mean {eqF.mean():9.2f}  dead {sum(r['dead'] for r in rsF)}/6  "
...
print("=" * 90)
print("SUMMARY (deployment already decided by the user - this is the record)")

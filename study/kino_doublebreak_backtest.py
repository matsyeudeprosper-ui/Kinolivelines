...
print(f'DOUBLE-BREAKOUT: twin-breakout required on BOTH H1 and H4 | START {START_BAL}', flush=True)
h1_prev1 = None
h1_prev2 = None
h4_prev1 = None
h4_prev2 = None
...
for i in range(N):
    ...
    if h1_prev1 is None or h1_prev2 is None:
        continue
    if h4_prev1 is None or h4_prev2 is None:
        continue
    ...
    if mode == 1 and not (h4_prev1[3] > h4_prev1[0] and h4_prev2[3] > h4_prev2[0] and h4_prev1[3] > h4_prev2[1]):
        continue                      # H4 twin-breakout for buys
    ...
    if mode == -1 and not (h4_prev1[3] < h4_prev1[0] and h4_prev2[3] < h4_prev2[0] and h4_prev1[3] < h4_prev2[2]):
        continue                      # H4 twin-breakout for sells

"""CONTINUOUS RUNNER variant (user question 2026-08-23): attempt a new
runner whenever clocks are aligned and no runner is active (not just at
alignment start).

Base: User idea 2026-08-22 #3: ALIGNED PARTIAL RUNNER.
...
i = 1
while i < N - 1:
    if aligned[i]:   # CONTINUOUS: re-attempt whenever aligned & no active runner
        d = int(h4[i])
